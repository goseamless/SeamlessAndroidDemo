...
public class SDBannerInScrollActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sdbannerinscroll);
        ...
        bannerManager = new BannerManager.Builder(this)
                ...
                .entity("seamless-banner-inScroll")
                .adView("250x150") // This is OPTIONAL i.e. = "250x150"/ the size of your SeamlessMMAView
                .category(AdCategory.AdCategories.Art) // Select proper category eg: News, Sports etc.
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_sdmre, menu);
        return true;
    }
